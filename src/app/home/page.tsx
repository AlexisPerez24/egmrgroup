...
// VERSIÓN PARA OPCIÓN 2 - LINKS A DIVISIONES
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes pulse-dot {
          0%,100% {
            box-shadow: 0 0 6px #38bdf8, 0 0 14px rgba(56,189,248,0.4);
          }
          50% {
            box-shadow: 0 0 10px #7dd3fc, 0 0 28px rgba(125,211,252,0.7);
          }
        }
        ...
        .hero-logo-wrap {
          ...
          width: 80px;
          height: 80px;
          animation: fadeSlideUp 1s 0.2s cubic-bezier(.22,1,.36,1) both;
        }
        .hero-logo-ring {
          position: absolute;
          inset: -4px;
        ...
        .hero-h1 {
          ...
          color: #fff;
          animation: fadeSlideUp 1s 0.35s cubic-bezier(.22,1,.36,1) both;
        }
        .hero-h1-accent {
          display: block;
        ...
        .hero-line {
          ...
          margin: 0 auto;
          animation: fadeSlideUp 1s 0.45s cubic-bezier(.22,1,.36,1) both;
        }
        .hero-desc {
          font-size: 15px;
          line-height: 1.8;
          ...
          max-width: 480px;
          font-weight: 300;
          animation: fadeSlideUp 1s 0.5s cubic-bezier(.22,1,.36,1) both;
        }
        ...
        .hero-btns {
          ...
          justify-content: center;
          gap: 12px;
          animation: fadeSlideUp 1s 0.6s cubic-bezier(.22,1,.36,1) both;
        }
        .hero-btn {
          position: relative;
          display: inline-flex;
        ...
        .hero-tags {
          ...
          justify-content: center;
          gap: 8px;
          animation: fadeSlideUp 1s 0.72s cubic-bezier(.22,1,.36,1) both;
        }
        .hero-tag {
          padding: 5px 14px;
          border-radius: 100px;
        ...
        .hero-divider {
          ...
          background: linear-gradient(
            ...
            rgba(125,211,252,0.15) 70%,
            transparent
          );
          margin: 28px 0;
          animation: fadeSlideUp 1s 0.55s cubic-bezier(.22,1,.36,1) both;
        }
